...
export interface operations {
    ...
    register: {
        ...
        responses: {
            201: components["responses"]["CommandSuccess"];
    ...
    verifyEmail: {
        ...
        requestBody?: never;
        responses: {
            /** @description Перенаправление на страницу входа с результатом подтверждения */
            302: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    listSessions: {
        ...
        requestBody?: never;
        responses: {
            /** @description Активные сессии без раскрытия cookie-токенов */
            200: {
                headers: {
                    [name: string]: unknown;
                };
